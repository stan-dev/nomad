#ifndef nomad__src__scalar__operators__nonsmooth_operators__operator_greater_than_hpp
#define nomad__src__scalar__operators__nonsmooth_operators__operator_greater_than_hpp

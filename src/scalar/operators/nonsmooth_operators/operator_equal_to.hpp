#ifndef nomad__src__scalar__operators__nonsmooth_operators__operator_equal_to_hpp
#define nomad__src__scalar__operators__nonsmooth_operators__operator_equal_to_hpp

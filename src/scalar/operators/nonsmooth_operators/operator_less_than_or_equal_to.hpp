#ifndef nomad__src__scalar__operators__nonsmooth_operators__operator_less_than_or_equal_to_hpp
#define nomad__src__scalar__operators__nonsmooth_operators__operator_less_than_or_equal_to_hpp

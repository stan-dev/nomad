#ifndef nomad__src__var__derived__multi_sum_var_body_hpp
#define nomad__src__var__derived__multi_sum_var_body_hpp
...
namespace nomad {
  ...
  public:
    ...
    multi_sum_var_body(nomad_idx_t n_inputs): var_base(n_inputs) {}

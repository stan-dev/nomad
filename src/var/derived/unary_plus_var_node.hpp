#ifndef nomad__src__var__derived__unary_plus_var_node_hpp
#define nomad__src__var__derived__unary_plus_var_node_hpp
...
namespace nomad {
  ...
  class unary_plus_var_node: public var_node_base {
  public:
    ...
    unary_plus_var_node(): var_node_base(1) {}

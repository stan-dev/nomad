#ifndef nomad__src__var__derived__binary_sum_var_body_hpp
#define nomad__src__var__derived__binary_sum_var_body_hpp
...
namespace nomad {
  ...
  class binary_sum_var_body: public var_base {
  public:
    ...
    binary_sum_var_body(): var_base(2) {}

#ifndef nomad__src__var__derived__unary_plus_var_body_hpp
#define nomad__src__var__derived__unary_plus_var_body_hpp
...
namespace nomad {
  ...
  class unary_plus_var_body: public var_base {
  public:
    ...
    unary_plus_var_body(): var_base(1) {}

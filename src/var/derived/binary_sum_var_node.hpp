#ifndef nomad__src__var__derived__binary_sum_var_node_hpp
#define nomad__src__var__derived__binary_sum_var_node_hpp
...
namespace nomad {
  ...
  class binary_sum_var_node: public var_node_base {
  public:
    ...
    binary_sum_var_node(): var_node_base(2) {}

...
TEST(ScalarNonSmoothOperators, OperatorLessThanOrEqualTo) {
  ...
  nomad::tests::test_derivatives<operator_less_than_or_equal_to_vv_func>(x1);
  ...
  x2[0] = 1.5;
  nomad::tests::test_derivatives<operator_less_than_or_equal_to_vd_func>(x2);
  nomad::tests::test_derivatives<operator_less_than_or_equal_to_dv_func>(x2);

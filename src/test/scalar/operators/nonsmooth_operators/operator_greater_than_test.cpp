...
TEST(ScalarNonSmoothOperators, OperatorGreaterThan) {
  ...
  nomad::tests::test_derivatives<false, false, operator_greater_than_vv_func>(x1);
  ...
  x2[0] = 1.5;
  nomad::tests::test_derivatives<false, false, operator_greater_than_vd_func>(x2);
  nomad::tests::test_derivatives<false, false, operator_greater_than_dv_func>(x2);

#ifndef nomad__scalar__functions__trinary_prod_cubes_hpp
#define nomad__scalar__functions__trinary_prod_cubes_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order> trinary_prod_cubes(const var<autodiff_order>& v1,

#ifndef nomad__scalar__functions__nonsmooth_functions__ceil_hpp
#define nomad__scalar__functions__nonsmooth_functions__ceil_hpp
...
namespace nomad {
  ...
  inline typename std::enable_if<!strict_smoothness, var<autodiff_order, strict_smoothness> >::type
    ceil(const var<autodiff_order, strict_smoothness>& input) {

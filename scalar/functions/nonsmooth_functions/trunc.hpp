#ifndef nomad__scalar__functions__nonsmooth_functions__trunc_hpp
#define nomad__scalar__functions__nonsmooth_functions__trunc_hpp
...
namespace nomad {
  ...
  inline typename std::enable_if<!strict_smoothness, var<autodiff_order, strict_smoothness> >::type
    trunc(const var<autodiff_order, strict_smoothness>& input) {
    ...
    push_dual_numbers<autodiff_order>(trunc(input.first_val()));

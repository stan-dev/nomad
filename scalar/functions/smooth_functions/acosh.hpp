#ifndef nomad__scalar__functions__smooth_functions__acosh_hpp
#define nomad__scalar__functions__smooth_functions__acosh_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    acosh(const var<autodiff_order, strict_smoothness>& input) {

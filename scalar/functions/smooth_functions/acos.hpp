#ifndef nomad__scalar__functions__smooth_functions__acos_hpp
#define nomad__scalar__functions__smooth_functions__acos_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    acos(const var<autodiff_order, strict_smoothness>& input) {
    ...
    push_dual_numbers<autodiff_order>(std::acos(x));

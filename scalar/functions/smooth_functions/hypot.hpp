#ifndef nomad__scalar__functions__smooth_functions__hypot_hpp
#define nomad__scalar__functions__smooth_functions__hypot_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    hypot(const var<autodiff_order, strict_smoothness>& v1,

#ifndef nomad__scalar__functions__smooth_functions__sinh_hpp
#define nomad__scalar__functions__smooth_functions__sinh_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    sinh(const var<autodiff_order, strict_smoothness>& input) {

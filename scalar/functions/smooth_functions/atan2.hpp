#ifndef nomad__scalar__functions__smooth_functions__atan2_hpp
#define nomad__scalar__functions__smooth_functions__atan2_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    atan2(const var<autodiff_order, strict_smoothness>& v1,

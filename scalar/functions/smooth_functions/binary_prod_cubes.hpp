#ifndef nomad__scalar__functions__smooth_functions__binary_prod_cubes_hpp
#define nomad__scalar__functions__smooth_functions__binary_prod_cubes_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    binary_prod_cubes(const var<autodiff_order, strict_smoothness>& v1,

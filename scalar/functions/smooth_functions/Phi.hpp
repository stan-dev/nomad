#ifndef nomad__scalar__functions__smooth_functions__Phi_hpp
#define nomad__scalar__functions__smooth_functions__Phi_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    Phi(const var<autodiff_order, strict_smoothness>& input) {

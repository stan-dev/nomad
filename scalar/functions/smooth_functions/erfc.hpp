#ifndef nomad__scalar__functions__smooth_functions__erfc_hpp
#define nomad__scalar__functions__smooth_functions__erfc_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    erfc(const var<autodiff_order, strict_smoothness>& input) {
    ...
    push_dual_numbers<autodiff_order>(erfc(x));

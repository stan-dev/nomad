#ifndef nomad__scalar__functions__smooth_functions__polygamma_hpp
#define nomad__scalar__functions__smooth_functions__polygamma_hpp

#include <math.h>
#include <scalar/constants.hpp>

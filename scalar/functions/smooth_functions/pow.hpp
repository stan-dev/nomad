#ifndef nomad__scalar__functions__smooth_functions__pow_hpp
#define nomad__scalar__functions__smooth_functions__pow_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    pow(const var<autodiff_order, strict_smoothness>& v1,

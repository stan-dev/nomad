#ifndef nomad__scalar__functions__smooth_functions__cos_hpp
#define nomad__scalar__functions__smooth_functions__cos_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    cos(const var<autodiff_order, strict_smoothness>& input) {

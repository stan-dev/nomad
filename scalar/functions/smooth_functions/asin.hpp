#ifndef nomad__scalar__functions__smooth_functions__asin_hpp
#define nomad__scalar__functions__smooth_functions__asin_hpp
...
namespace nomad {
  ...
  inline var<autodiff_order, strict_smoothness>
    asin(const var<autodiff_order, strict_smoothness>& input) {
